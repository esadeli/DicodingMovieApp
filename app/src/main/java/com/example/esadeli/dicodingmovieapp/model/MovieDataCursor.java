...
import com.example.esadeli.dicodingmovieapp.data.DatabaseContract;

import static android.provider.BaseColumns._ID;
import static com.example.esadeli.dicodingmovieapp.data.DatabaseContract.getColumnInt;
import static com.example.esadeli.dicodingmovieapp.data.DatabaseContract.getColumnString;

/**
 * Created by esadeli on 02/08/18.
 *
 * Simple POJO Class to display data from database
 */
